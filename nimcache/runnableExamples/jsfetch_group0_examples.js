...
function reprEnum(e_p0, typ_p1) {
  ...
  framePtr = F;
    ...
    var tmp_33557643 = false;
    F.line = 31;
    var item_33557644 = typ_p1.node.sons[e_p0];
    F.line = 32;
    tmp_33557643 = item_33557644 !== undefined;
    if (tmp_33557643) {
    F.line = 34;
    result_33557642 = nimCopy(null, makeNimstrLit(item_33557644.name), NTI33554449);
    }
    else {
      F.line = 36;
      result_33557642 = nimCopy(null, (HEX24__systemZdollars_u14(e_p0)).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41]), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557642;
...
function auxWriteStackTrace__system_u2094(f_p0) {
  var result_33556528 = [[]];
    ...
    result_33556528[0].push.apply(result_33556528[0], [40]);;
    result_33556528[0].push.apply(result_33556528[0], HEX24__systemZdollars_u14((total_33556535 - i_33556534)));;
    result_33556528[0].push.apply(result_33556528[0], [32,99,97,108,108,115,32,111,109,105,116,116,101,100,41,32,46,46,46,10]);;
    }
    ...
    Label5: {
      ...
      Label6: {
          ...
          if (!(0 <= res_687866308)) break Label7;
            ...
            result_33556528[0].push.apply(result_33556528[0], cstrToNimstr(tempFrames_33556536[j_33556569].Field2));;
            ...
            if (false) {
            result_33556528[0].push.apply(result_33556528[0], [44,32]);;
            addInt__stdZprivateZdigitsutils_u241(result_33556528, 0, 0);
            }
            
            result_33556528[0].push.apply(result_33556528[0], [41]);;
            }
            
            result_33556528[0].push.apply(result_33556528[0], [32,97,116,32]);;
            add__system_u1950(result_33556528, 0, tempFrames_33556536[j_33556569].Field0);
            result_33556528[0].push.apply(result_33556528[0], [10]);;
            res_687866308 -= 1;
          }
      };
    };
...
function unhandledException(e_p0) {
    ...
    buf_33556665[0].push.apply(buf_33556665[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110,58,32]);;
    buf_33556665[0].push.apply(buf_33556665[0], e_p0.message);;
    }
    else {
    buf_33556665[0].push.apply(buf_33556665[0], [69,114,114,111,114,58,32,117,110,104,97,110,100,108,101,100,32,101,120,99,101,112,116,105,111,110]);;
    }
    
    buf_33556665[0].push.apply(buf_33556665[0], [32,91]);;
    add__system_u1950(buf_33556665, 0, e_p0.name);
    buf_33556665[0].push.apply(buf_33556665[0], [93,10]);;
    buf_33556665[0].push.apply(buf_33556665[0], rawWriteStackTrace__system_u2187());;
